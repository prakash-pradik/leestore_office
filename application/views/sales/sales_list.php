<div id="page-content">
    ...
    <div class="row text-center" style="display: flex;justify-content: center;">
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="<?php echo base_url('sales_credit/'.$url_segment); ?>" class="widget widget-hover-effect2">
                <div class="widget-extra themed-background-fire">
                    <h4 class="widget-content-light"><strong>Credit</strong> Sales</h4>
                </div>
                <div class="widget-extra-full"><span class="h2 animation-expandOpen"><?php if(isset($stats) && $stats->total_credit) echo $stats->total_credit; else echo '0'; ?></span></div>
            </a>
        </div>
    </div>
                    ...
                    <?php if(!empty($orders)) {
                        ...
                        foreach($orders as $order){
                            ...
                            if($order['payment_mode'] == 'cash')
                                $payMode = '<a href="javascript:void(0)" class="label label-success pay-label">Cash</a>';
                            else if($order['payment_mode'] == 'multipay')
                                $payMode = '<a href="javascript:void(0)" class="label label-warning pay-label">Multipay</a>';
                            else
                                $payMode = '<a href="javascript:void(0)" class="label label-primary pay-label">UPI</a>';
                    ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <a href="<?php echo base_url('sales/invoice/'.$order['id']); ?>" data-toggle="tooltip" title="View" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
