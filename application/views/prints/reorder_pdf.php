            ...
            <div class="card-body">
                <div class="overflow-auto">
                    <div style="min-width: 600px">
                        ...
                        <h3 class="text-center" style="padding-bottom:10px"> Products Count Report</h3>
                        <div class="invoice">
                            <table>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php if(isset($reorders) && !empty($reorders)) {
                                        $i = 1; 
                                        foreach($reorders as $reo){
                                    ?>
                                    <tr>
                                        <td class="text-center"><?php echo $i; ?></td>
                                        <td style="text-transform:capitalize;"><?php echo $reo['product_name']; ?></td>
                                        <td>
                                            <h4 class="text-danger"> <?php echo $reo['qnty']; ?> </h4>
                                        </td>
                                        <td class=""><?php echo $reo['store_name']; ?></td>
                                    </tr>
                                    <?php
                                    $i++;
                                        }
