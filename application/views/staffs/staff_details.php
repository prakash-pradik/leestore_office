    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-file-o"></i> <strong>Staff</strong> Info</h2>
                </div>
                ...
                <div class="block-section text-center">
                    ...
                    <h3>
                        <strong><?php if(!empty($employee)) echo $employee->full_name; ?></strong><br><small></small>
                    </h3>
        ...
        <div class="col-lg-8">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-mobile"></i> <strong>Sales</strong> By Staff</h2>
                </div>
