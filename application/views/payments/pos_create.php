                ...
                <div class="col-md-8">
                    ...
                    <div class="block">
                        <div class="text-center">
                            <button type="button" class="btn btn-lg btn-danger" onclick="saveCash('credit');">
                            ...
                            <button type="button" class="btn btn-lg btn-warning" onclick="openMultiPayModal();">
                                <i class="gi gi-sort"></i> Multi Pay
                            </button>
                            <button type="button" class="btn btn-lg btn-primary" onclick="saveCash('upi');">
                                <i class="fa fa-credit-card"></i> UPI
                            </button>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="col-md-5 text-right">
                                <div class="" style="width:60%; float:right;">
                                    <input type="text" id="round_off" name="round_off" class="form-control numeric" maxlength="4">
                                </div>
                            </div>
                        </div> -->
                        <div class="form-group">
