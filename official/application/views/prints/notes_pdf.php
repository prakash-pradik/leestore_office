            ...
            <div class="card-body">
                <div class="overflow-auto">
                    <div style="min-width: 600px">
                        ...
                        <h3 class="text-center" style="text-transform:capitalize;padding-bottom:10px"> Notes (<?php echo date("d-M-Y l"); ?>) </h3>
                        <div class="invoice">
                            <textarea class="form-control" rows="40" style="padding:30px">
                                <?php if(!empty($daily_notes)) echo $daily_notes->notes; ?>
                            </textarea>
                        </div>
