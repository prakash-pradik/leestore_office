    ...
    <div class="block full">
        <div class="block-title">
            ...
            <div class="block-options pull-right">
                ...
                <a href="<?php echo base_url('Prints/inoutPdf/incomes'); ?>" class="btn btn-alt btn-warning" data-toggle="tooltip" title="Print"><i class="gi gi-print"></i></a>
            ...
            <table id="income-datatable" class="table table-vcenter table-condensed table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>₹ <?php  echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $income['total_credit']); ?></td>
                        <!-- <td><?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $income['total_debit']); ?></td> -->
                        <td><h4 class="text-success">₹ <?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $income['total_available']); ?></h4></td>
